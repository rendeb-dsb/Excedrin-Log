const KEY="excedrinData", DB_NAME="ExcedrinDB", DB_VERSION=1, STORE_NAME="records", VERSION=31;
...
function setActionsEnabled(enabled){
  ...
  fileButton.setAttribute("aria-disabled",String(!enabled));
  fileMenu.querySelectorAll("button").forEach(b=>{b.disabled=!enabled;b.setAttribute("aria-disabled",String(!enabled));});
...
if("serviceWorker" in navigator){
  navigator.serviceWorker.register("sw-v31.js").then(reg=>{
